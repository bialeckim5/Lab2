public class Lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = 1 + numWives + (numWives * numSacksPerWife) + (numWives * numSacksPerWife * numCatsPerSack) + (numWives * numSacksPerWife * numCatsPerSack * numKitsPerCat);
	} else {
	...
	int the_total_variable = total;
	System.out.println();
	System.out.println("Number going to St. Ives is " + the_total_variable);
    }
